...
export default async function TenantDetailPage({
  ...
  if (subscription?.activated_at) {
    ...
    // This is a server component — runs once per request on the server, not during
    // a client re-render, so "impure during render" doesn't apply the way it does
    // for client components; suppressed rather than restructured.
